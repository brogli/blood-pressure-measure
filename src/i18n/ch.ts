export const ch = {
  ...
  measurementList: {
    ...
    confirmDeleteText:
      'Das löscht ALLI dini Mässige wo d App selber speicheret. Bisch sicher wotsch das mache?',
  },
  menu: {
  ...
  consent: {
    title: 'Dateschutz',
    intro:
      'Gseht so us, als benutzisch die App s erste Mol. Mitem Witerbenutze akzeptiersch, dass:',
    appLivesInBrowser: "d'App nur in dim Browser existiert",
    doesntTransmitData:
      "d'App kei Date ins Internet schickt, sofern si oder dis Grät nöd ghackt worde isch",
    localStorageConsent:
