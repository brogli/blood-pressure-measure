export const en = {
  ...
  measurementList: {
    ...
    confirmDeleteText:
      'This will delete ALL measurements the app saves by itself. Sure you want to do this?',
  },
  menu: {
  ...
  aboutAndHelp: {
    ...
    dataP3:
      "It's therefore recommended to create backups usign the export and import functionality.",
  ...
  consent: {
    title: 'Data Privacy',
    intro:
      "Looks like you're using this app the first time. By continuing to use it you accept that:",
