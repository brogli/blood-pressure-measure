export const de = {
  ...
  aboutAndHelp: {
    ...
    dataP3:
      'Es ist daher empfohlen, die Export und Import Funktion zu nutzen, um ein Backup der Daten zu erhalten.',
  ...
  consent: {
    title: 'Datenschutz',
    intro:
      'Siehst so aus, als nutzt du die App das erste Mal. Mit dem Weiternutzen akzeptierst du, dass:',
    appLivesInBrowser: 'die App nur in deinem Browser existiert',
    doesntTransmitData:
      'die App keine Daten ins Internet übermittelt, sofern sie oder dein Gerät nicht gehackt wurde',
    localStorageConsent:
